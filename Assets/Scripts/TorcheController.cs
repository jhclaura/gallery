...
public class TorcheController : MonoBehaviour {
    ...
    */
	...
	void Update () {
		...
		TorchLight.GetComponent<Light>().intensity=IntensityLight/2f+Mathf.Lerp(IntensityLight-0.1f,IntensityLight+0.1f,Mathf.Cos(Time.time* FlickerFrequency));
