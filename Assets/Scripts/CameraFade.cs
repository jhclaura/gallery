...
// Extended for full-circle: laurachen
...
{   
	...
	public float m_FadeMiddleDelay = 0;
	public Action m_OnFadeInFinish = null;

	public bool m_FadeInOut = false;
	public float m_FadeDuration = 0f;
				...
				if (Mathf.Abs(instance.m_CurrentScreenOverlayColor.a - instance.m_TargetScreenOverlayColor.a) < Mathf.Abs(instance.m_DeltaColor.a) * Time.deltaTime)
				{
					if (!instance.m_FadeInOut) {
						...
						if (instance.m_OnFadeInFinish != null) {
							...
							// Reset
							instance.m_OnFadeInFinish = null;
						}

						instance.m_FadeDelay = Time.time + instance.m_FadeMiddleDelay;
						StartAlphaFade ( instance.m_TargetScreenOverlayColor, true, instance.m_FadeDuration );

						// Reset
						instance.m_FadeDuration = 0f;
						instance.m_FadeMiddleDelay = 0f;
					}
				}
				else
				{
	...
	/// <param name="OnFadeInFinish">On fade in finish.</param>
	public static void StartAlphaFadeInOut(Color newScreenOverlayColor, float fadeDuration, float fadeDelay, Action OnFadeInFinish )
	{
		if (fadeDuration <= 0.0f)		
		{
			SetScreenOverlayColor(newScreenOverlayColor);
		...
		{
			instance.m_FadeInOut = true;
			instance.m_FadeDuration = fadeDuration;
			instance.m_OnFadeInFinish = OnFadeInFinish;
			instance.m_FadeMiddleDelay = fadeDelay;
